      ...
      <div className="flex flex-col gap-y-8">
        ...
        {isLoading ? (
          ...
          <div className="flex items-center justify-between space-x-6 ">
            <div className="bg-[#1F2940] p-6 small:pl-6 pl-16 rounded-lg text-gray-300 w-1/2">
              <div className="flex overflow-auto">
                {/* Left Side for K6 */}
                <div className="flex flex-col   w-1/2  border-r-2 border-gray-600">
                  <div className="-rotate-90 text-2xl items-start font-semibold text-gray-200 self-center text-left flex my-auto mr-auto pr-10 small:pr-5">
                    SOFIA
                  </div>
                  <div className="relative flex items-center pb-4">
                    ...
                    <div className="flex items-center relative">
                      ...
                      <div className=" inset-0 h-[2px] bg-gray-600 z-0 top-[17px] w-[10rem] small:w-20"></div>
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-[#1F2940] p-6 pl-16 small:pl-6 rounded-lg text-gray-300 w-1/2">
              <div className="flex overflow-auto">
                {/* Right Side for Other Rows */}
                ...
                <div className="flex flex-col w-1/2  items-center ">
                  <div className="relative flex items-center pt-4">
                    ...
                    <div className="flex items-center relative">
                      ...
                      <div className=" inset-0 h-[2px] bg-gray-600 z-0 top-[17px] w-[5rem] small:w-12"></div>
